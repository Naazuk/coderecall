...
<body>
  ...
  useEffect(() => {
    ...
    setTaskSolved(completedTasks.includes('css-animations'));
  }, []);
...
//   }, []);
  ...
  const markAsSolved = () => {
    if (!taskSolved) {
      ...
      const completedTasks = JSON.parse(localStorage.getItem('completedTasks')) || [];
      completedTasks.push('css-animations'); // Adjust this ID for each task
  ...
  <script>
    function toggleMenu() {
      ...
      navLinks.classList.toggle('active');
          ...
          <div className="page" style={{width:'100%', padding:'6px'}}>
            <div className="left">
